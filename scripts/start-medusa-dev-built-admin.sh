...
NODE_ENV=production DISABLE_MEDUSA_ADMIN=false MEDUSA_WORKER_MODE=server pnpm --filter @dtc/backend build
node /server/scripts/check-medusa-build-output.js
